...
namespace Zig.Tasks
{
    public sealed class ZigFormat : ZigToolTask
    {
        ...
        protected override bool HandleTaskExecutionErrors()
        {
            ...
            // In check mode, zig fmt will just print a list of files to
            // standard output and exit with a non-zero code. This causes
            // ToolTask.HandleTaskExecutionErrors to log an error notifying the
            // user of the exit code. This can be a bit confusing to a user who
            // is not already familiar with zig fmt's behavior. So, we try to
            // present a more actionable error message to the user.
            //
